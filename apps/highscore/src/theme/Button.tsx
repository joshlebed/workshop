    ...
    >
      {loading ? (
        ...
        <>
          ...
          <Text
            style={[
              // One button style app-wide: short labels set in the pixel face
              // (DESIGN.md allows Press Start 2P on buttons at ≥12px when the
              // label is short), long ones fall back to system semibold so
              // they don't blow the button open.
              label.length <= PIXEL_LABEL_MAX ? pixelLabel : styles.label,
...
const PIXEL_LABEL_MAX = 16;
const pixelLabel = pixelType(12);
