...
const styles = StyleSheet.create({
  ...
  sheetShell: { pointerEvents: "box-none" },
  // Canvas fill + a single top bezel, exactly like the dock: a sheet reads as
  // the dock grown upward rather than a separate floating panel.
  sheet: {
