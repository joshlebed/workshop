...
// content — see the Sheet note in the root CLAUDE.md), restyled onto the
// HighScore tokens: surface.2 fill, sharp corners, 2px purple bezel.
...
const styles = StyleSheet.create({
  ...
  sheetWrap: { pointerEvents: "box-none" },
  sheet: {
