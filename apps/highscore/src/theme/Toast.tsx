...
const styles = StyleSheet.create({
  viewport: {
    position: "absolute",
    // Clear of the control panel and the recap bar that can ride on top of
    // it — the panel assembly is the app's bottom edge.
    bottom: deck.panelHeight + deck.recapHeight + tokens.space.sm,
    left: 0,
    right: 0,
    alignItems: "center",
    gap: tokens.space.sm,
