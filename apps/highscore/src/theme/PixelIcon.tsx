...
// Metro and the Cloudflare Pages bundler both choke on raw .svg imports, so
// the `d` strings live here; add a name by copying from
...
const PATHS = {
  ...
  "avatar-square-minus": [
    "M4 2h16v2H4zm0 18h10v2H4zM2 4h2v16H2zm18 0h2v10h-2zM6 18h2v2H6zm2-2h6v2H8zm2-4h4v2h-4zM8 8h2v4H8zm2-2h4v2h-4zm4 2h2v4h-2zm2 10h6v2h-6z",
  ],
  "drag-and-drop": [
