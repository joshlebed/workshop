...
export const SUPPORT_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The Send feedback button on your account sheet pre-fills the app version and platform for you.",
    ],
  },
  {
    heading: "Account deletion",
    body: [
      "Delete your account from inside the app: tap your picture (top right) → Danger zone → Delete account. It takes effect immediately and can't be undone.",
...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "You can delete your account at any time from the app: tap your picture (top right) → Danger zone → Delete account. Deletion is immediate and permanent — your profile, scores, reactions, friend connections, invites, and share links are removed, not deactivated, and it can't be undone.",
